...
<div  class="content">
	<div class="formList">
		<form name="aForm" id="roleform" method="post">
			...
			<ul>
				<li><span class="labelName">角色名称:</span><input type="text" name="title" value=${ar.title }  class="textStyle"/></li>
				<li><span class="labelName">角色描述:</span><input type="text" name="descp" value=${ar.descp }  class="textStyle"/></li>
