 ...
 * 
 */
public class PriceMonitor29DAOObjectMapper implements ObjectMapper {
	private static final Logger log = LoggerFactory
			.getLogger(PriceMonitor29DAOObjectMapper.class);

	public Object mapping(ResultSet rs) {
		PriceMonitor29 priceMonitor = new PriceMonitor29();
		try {
