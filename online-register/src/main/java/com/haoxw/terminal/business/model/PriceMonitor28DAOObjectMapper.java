 ...
 * 
 */
public class PriceMonitor28DAOObjectMapper implements ObjectMapper {
	private static final Logger log = LoggerFactory
			.getLogger(PriceMonitor28DAOObjectMapper.class);

	public Object mapping(ResultSet rs) {
		PriceMonitor28 priceMonitor = new PriceMonitor28();
		try {
