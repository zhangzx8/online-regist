 ...
 * 
 */
public class PriceMonitorDAOObjectMapper implements ObjectMapper {
	private static final Logger log = LoggerFactory
			.getLogger(PriceMonitorDAOObjectMapper.class);

	public Object mapping(ResultSet rs) {
		PriceMonitor priceMonitor = new PriceMonitor();
		try {
			priceMonitor.setP_id(rs.getInt("p_id"));
			...
			priceMonitor.setP_31(rs.getInt("p_31"));
